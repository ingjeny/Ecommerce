...
<body>
    ...
    <header class="bg-dark py-1">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-5 fw-bolder">Ecommerce</h1>
            </div>
        </div>
    </header>
    <section class="py-5">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <!-- Product price-->
                                        <span class="text-muted text-decoration-line-through"><?php echo '$' . number_format($data['precio_normal'], 0, '', '.'); ?> COP</span>
                                        <?php echo '$' . number_format($data['precio_rebajado'], 0, '', '.'); ?> COP
                                    </div>
                                </div>
                                <!-- Product actions-->
    ...
    <footer class="footer py-5">
        <div class="container">
        <p class="m-0 text-center text-gradient fs-5">Erick y Brenda Ingenieria en software<?php echo date('Y'); ?> FESC</p>
    </footer>
    <!-- Bootstrap core JS-->
